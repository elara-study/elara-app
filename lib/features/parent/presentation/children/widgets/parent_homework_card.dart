...
import 'package:elara/features/parent/presentation/children/widgets/parent_homework_dialog_content.dart';
    ...
    return GestureDetector(
      onTap: () {
        AppDialog.show(
          context: context,
          builder: (_) => AppDialog(
            title: entity.status == ParentHomeworkStatus.active
                ? 'Problem List'
                : 'Submission',
            content: ParentHomeworkDialogContent(homework: entity),
          ),
        );
      },
      child: Container(
