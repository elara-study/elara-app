...
class TeacherGroupModel extends TeacherGroupEntity {
  ...
  factory TeacherGroupModel.fromJson(Map<String, dynamic> json) {
    return TeacherGroupModel(
      id: json['id'] as String? ?? '', // API might not return it yet based on swagger
      name: json['name'] as String,
      grade: json['grade']?.toString() ?? '0', // Swagger says int, GroupEntity expects String
  ...
  Map<String, dynamic> toJson() {
    return {
      'name': name,
      'grade': int.tryParse(grade) ?? 0, // Convert back to int for the request body
      'subject': subject,
