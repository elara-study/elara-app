...
import 'package:elara/features/teacher/group/domain/entities/teacher_group_entity.dart';
...
class TeacherGroupRepositoryImpl implements TeacherGroupRepository {
  ...
  @override
  Future<Either<Failure, TeacherGroupDetailEntity>> getGroupDetail(String groupId) async {
    try {
  ...
  @override
  Future<Either<Failure, List<GroupAnnouncement>>> getAnnouncements(String groupId) async {
    try {
  ...
  @override
  Future<Either<Failure, void>> addAnnouncement(String groupId, String title, String content) async {
    try {
  ...
  @override
  Future<Either<Failure, void>> deleteAnnouncement(String groupId, String announcementId) async {
    try {
  ...
  @override
  Future<Either<Failure, TeacherRoadmapEntity>> getRoadmap(String groupId) async {
    try {
  ...
  @override
  Future<Either<Failure, TeacherStudentInsightEntity?>> getStudentInsights(String studentId) async {
    try {
