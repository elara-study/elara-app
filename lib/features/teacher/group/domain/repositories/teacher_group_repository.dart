...
abstract class TeacherGroupRepository {
  ...
  Future<Either<Failure, List<GroupAnnouncement>>> getAnnouncements(String groupId);

  Future<Either<Failure, void>> addAnnouncement(String groupId, String title, String content);

  Future<Either<Failure, void>> deleteAnnouncement(String groupId, String announcementId);

  Future<Either<Failure, TeacherRoadmapEntity>> getRoadmap(String groupId);

  Future<Either<Failure, TeacherStudentInsightEntity?>> getStudentInsights(String studentId);
}
